...
CREATE TABLE site (site_id INTEGER PRIMARY KEY NOT NULL, title TEXT, desc TEXT, requireloginforpageview INTEGER NOT NULL, allowanonreplies INTEGER NOT NULL, loginmsg TEXT);
